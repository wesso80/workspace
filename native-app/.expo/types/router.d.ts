...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/alerts` | `/alerts` | `/(tabs)/` | `/(tabs)` | `/(tabs)/journal` | `/journal` | `/(tabs)/portfolio` | `/portfolio` | `/(tabs)/settings` | `/settings` | `/add-alert` | `/add-trade` | `/onboarding` | `/search`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/stock/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/stock/[symbol]`;
